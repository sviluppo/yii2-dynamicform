<?php
/**
 * @link      https://github.com/sviluppo/yii2-dynamicform
 * @copyright Copyright (c) 2014 Wanderson Bragança
 * @license   https://github.com/sviluppo/yii2-dynamicform/blob/master/LICENSE
 */

namespace sviluppo\dynamicform;
...
class DynamicFormWidget extends \yii\base\Widget
{
    ...
    public function registerAssets($view)
    {
        ...
        $js = 'jQuery("#' . $this->formId . ' .'.$this->widgetContainer.'").on("click", "' . $this->insertButton . '", function(e) {'. "\n";
        $js .= "    e.preventDefault();\n";
        ...
        $js = 'jQuery("#' . $this->formId . ' .'.$this->widgetContainer.'").on("click", "' . $this->deleteButton . '", function(e) {'. "\n";
        $js .= "    e.preventDefault();\n";
